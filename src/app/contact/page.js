  ...
  return (
    <>
            ...
            <div className="contact-details">
              ...
              <div className="contact-detail-item">
                ...
                <div className="contact-detail-text">
                  ...
                  <span>1305 Paterson Plank Rd</span>
                  <span>North Bergen, NJ, USA</span>
                </div>
                <div className="contact-detail-text">
                  <span className="contact-detail-label">Address</span>
      ...
      <section className="contact-map-section">
        <iframe
          src="https://www.google.com/maps?q=2525+US-130,+Cranbury,+NJ+08512,+USA&output=embed"
          width="100%"
          height="400"
          style={{ border: 0 }}
          allowFullScreen=""
