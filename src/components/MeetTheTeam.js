...
const MeetTheTeam = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "Expert in MEP coordination and clash detection with 12+ years experience.",
      social: {
        linkedin: "#",
        twitter: "#",
        email: "david@thezenithvisions.com",
      },
    },
    {
      id: 5,
      ...
      bio: "Delivering precise structural BIM models for high-rise and infrastructure projects.",
      social: {
        linkedin: "#",
        twitter: "#",
        email: "jennifer@thezenithvisions.com",
      },
    },
    {
      id: 6,
      ...
      bio: "Ensuring quality and standards across all BIM deliverables and workflows.",
      social: {
        linkedin: "#",
        twitter: "#",
        email: "robert@thezenithvisions.com",
      },
    },
  ];
